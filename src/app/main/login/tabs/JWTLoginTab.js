...
import { submitLoginWithSuperbase } from "app/auth/store/loginSlice";
...
function JWTLoginTab(props) {
  ...
  useEffect(() => {
    setValue("email", "dojox69183@godpeed.com", {
      shouldDirty: true,
      shouldValidate: true,
    });
    setValue("password", "Vimal123*", { shouldDirty: true, shouldValidate: true });
  ...
  function onSubmit(model) {
    ...
    dispatch(submitLoginWithSuperbase(model));
  }
